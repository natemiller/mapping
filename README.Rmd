...
knitr::include_graphics(here::here('images','image (6).png'))
```

1.  The intersection of the line and the sf shape is then calculated.

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics(here::here('images','image (7).png'))
```

1.  The line intersection is then buffered a very small amount
    (exaggerated below for the visual).

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics(here::here('images','image (8).png'))
```

1.  The shape can then be reprojected with a new center. However, when
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics(here::here('images','image (9).png'))
```

1.  To avoid this the `recenter_sf` function adds additional vertices to
    those polygons that are cut, which results in a curved edge
    `(see below)`.

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics(here::here('images','image (10).png'))
```
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics(here::here('images','unnamed-chunk-3-1.png'))
```
